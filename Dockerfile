...
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:3338 -t_srs CRS:84 flowpaths.geojson /raw_hf/ak_nextgen.gpkg flowpaths
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:3338 -t_srs CRS:84 divides.geojson /raw_hf/ak_nextgen.gpkg divides
...
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:3338 -t_srs CRS:84 flowpaths.geojson /raw_hf/gl_nextgen.gpkg flowpaths
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:3338 -t_srs CRS:84 divides.geojson /raw_hf/gl_nextgen.gpkg divides
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:5070 -t_srs CRS:84 hydrolocations.geojson /raw_hf/gl_nextgen.gpkg hydrolocations
...
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs ESRI:102007 -t_srs CRS:84 flowpaths.geojson /raw_hf/hi_nextgen.gpkg flowpaths
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs ESRI:102007 -t_srs CRS:84 divides.geojson /raw_hf/hi_nextgen.gpkg divides
...
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:6566 -t_srs CRS:84 flowpaths.geojson /raw_hf/prvi_nextgen.gpkg flowpaths
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:6566 -t_srs CRS:84 divides.geojson /raw_hf/prvi_nextgen.gpkg divides
...
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:5070 -t_srs CRS:84 flowpaths.geojson /raw_hf/conus_nextgen.gpkg flowpaths
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:5070 -t_srs CRS:84 divides.geojson /raw_hf/conus_nextgen.gpkg divides
RUN ogr2ogr -simplify 1 -lco SIGNIFICANT_FIGURES=7 -s_srs EPSG:5070 -t_srs CRS:84 hydrolocations.geojson /raw_hf/conus_nextgen.gpkg hydrolocations

FROM ak_to_geojson AS ak_to_mbtiles
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles -l ak_flowpaths -x dist_4.twi --extend-zooms-if-still-dropping flowpaths.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=divide_id -o divides.mbtiles -l ak_divides -x dist_4.twi --extend-zooms-if-still-dropping divides.geojson -P
RUN tile-join -pk -o ak.mbtiles flowpaths.mbtiles divides.mbtiles

FROM gl_to_geojson AS gl_to_mbtiles
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles -l gl_flowpaths -x dist_4.twi --extend-zooms-if-still-dropping flowpaths.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=divide_id -o divides.mbtiles -l gl_divides -x dist_4.twi --extend-zooms-if-still-dropping divides.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z2 -r1 --cluster-distance=5 -o hydrolocations.mbtiles -l gl_hydrolocations hydrolocations.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z3 -r1 -j '{ "*": [ "any", [ "==", "hl_reference", "gages" ]] }' -o gages.mbtiles -l gl_gages hydrolocations.geojson -P
...
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles -l hi_flowpaths -x dist_4.twi --extend-zooms-if-still-dropping flowpaths.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=divide_id -o divides.mbtiles -l hi_divides -x dist_4.twi --extend-zooms-if-still-dropping divides.geojson -P
RUN tile-join -pk -o hi.mbtiles flowpaths.mbtiles divides.mbtiles

FROM prvi_to_geojson AS prvi_to_mbtiles
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles -l prvi_flowpaths -x dist_4.twi --extend-zooms-if-still-dropping flowpaths.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=divide_id -o divides.mbtiles -l prvi_divides -x dist_4.twi --extend-zooms-if-still-dropping divides.geojson -P
RUN tile-join -pk -o prvi.mbtiles flowpaths.mbtiles divides.mbtiles

FROM conus_to_geojson AS conus_to_mbtiles
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles -l conus_flowpaths -x dist_4.twi --extend-zooms-if-still-dropping flowpaths.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=divide_id -o divides.mbtiles -l conus_divides -x dist_4.twi --extend-zooms-if-still-dropping divides.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z2 -r1 --cluster-distance=5 -o hydrolocations.mbtiles -l conus_hydrolocations hydrolocations.geojson -P
RUN tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z3 -r1 -j '{ "*": [ "any", [ "==", "hl_reference", "gages" ]] }' -o gages.mbtiles -l conus_gages hydrolocations.geojson -P
...
#tippecanoe -S 10 -pn --single-precision -x fid -z10 -Z8 --use-attribute-for-id=id -o flowpaths.mbtiles --coalesce-densest-as-needed --extend-zooms-if-still-dropping flowpaths.geojson --force -P
